...
    try {
      // BADLAV YAHAN KIYA GAYA HAI
      const response = await fetch(`${API_BASE_URL}/api/users/admin/users/${id}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`,
        },
...
    // BADLAV YAHAN KIYA GAYA HAI
    let url = `${API_BASE_URL}/api/users/admin/users`;
    let method = "POST";

    if (currentUser) { // Edit mode
      // BADLAV YAHAN BHI KIYA GAYA HAI
      url = `${API_BASE_URL}/api/users/admin/users/${currentUser.id}`;
      method = "PUT";
    }
